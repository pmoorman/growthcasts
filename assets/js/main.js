...
const Parallax = {
  ...
  setTranslate() {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      $(slideEl).find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each((index$$1, el) => {
...
// Swiper Class
// Core Modules
const components = [Device$2, Support$2, Browser$2, Resize, Observer$1, Virtual$1, Keyboard$1, Mousewheel$1, Navigation$1, Pagination$1, Scrollbar$1, Parallax$1, Zoom$1, Lazy$1, Controller$1, A11y, History$1, HashNavigation$1, Autoplay$1, EffectFade, EffectCube, EffectFlip, EffectCoverflow];
...
/**
 * Scrolls window to the passed destination anchor.
 *
 ...
 */
function scrollIt(destination, duration = 750, easing = 'easeInOutCubic', callback) {
